...
- 当 KK 在对话中粘贴以 `# TEXT` / `TEXT1` / `TEXT2` / `TEXT3` / `TEXT4` 开头的考研英语阅读做题痕迹时，默认不要泛泛翻译文章，而是按 [[2.知识库/20.North_star_ZJU/200.英语积累/01考研真题/英语阅读辅助提示词.md]] 的流程处理。
- 处理重点：错因诊断、词义语境卡、搭配-句模卡、可写入 [[2.知识库/20.North_star_ZJU/200.英语积累/01考研真题/阅读错因台账.md]] 的表格。
- 除非 KK 明确要求，否则不要把每个生词都扩展成大词库；每篇 Text 只保留会改变下次做题结果的最小复习点。
